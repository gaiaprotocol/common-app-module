...
export default abstract class EventContainer {
    ...
    private removeDelegateEvents(delegateEvents: { delegate: EventContainer, events: Events }): void {
    ...
    public onDelegate(delegate: EventContainer, eventName: string, eventHandler: EventHandler): void {
