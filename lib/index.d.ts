...
export { default as Rich, UploadedFile, isEqualRich } from "./database-interface/Rich.js";
export { default as UserPublic, isEqualUserPublic } from "./database-interface/UserPublic.js";
