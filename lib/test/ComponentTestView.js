...
export default class ComponentTestView extends View {
    ...
    constructor(params) {
        super();
        BodyNode.append(this.container = el(".component-test-view.test-view", el("h1", "Component Test View"), el("section.tabs", el("h2", "Tabs"), el("p", "This is a test of the tab component."), el(".component-container", new Tabs("test", Array.from({ length: 9 }, (_, index) => ({
            id: `tab${index + 1}`,
            label: `Tab ${index + 1}`,
        }))).init())), el("section.dialogues", el("h2", "Dialogues"), el("p", "This is a test of the dialogue components."), el(".component-container", new Button({
            title: "Alert",
            click: () => new Alert({
                title: "Alert",
            ...
            tag: ".send",
            title: "Send",
        }), { submit: (event) => this.submit(event) })), el("section.buttons", el("h2", "Buttons"), el("p", "This is a test of the button component."), el(".component-container", new Button({
            title: "Text",
        }), new Button({
            type: ButtonType.Contained,
            title: "Contained",
