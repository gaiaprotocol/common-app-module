...
class TestUploadForm extends UploadForm {
    ...
    constructor() {
        ...
        this.append(el("form", this.input = new FileDropArea({ tag: ".file-drop-area" }, (files) => this.appendFiles(files)), this.uploadPreviewArea = el(".upload-preview-area")), el("footer", el("section.rich", el("button", new Icon("image"), {
